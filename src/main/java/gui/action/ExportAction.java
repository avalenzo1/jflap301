...
public class ExportAction extends RestrictedAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        Universe.CHOOSER.addChoosableFileFilter(new javax.swing.filechooser.FileFilter() {
            @Override
        ...
        while (result == JFileChooser.APPROVE_OPTION) {
            ...
            if (file.exists()) {
                int confirm = JOptionPane.showConfirmDialog(Universe.CHOOSER, "File exists. Shall I overwrite?",
